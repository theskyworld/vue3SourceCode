...
const OPENBLOCK = Symbol("openBlock");
...
function genElement(node, context) {
    ...
    if ((children && isEmpty(children)) || !children) {
        ...
        if (node.children) {
            if (node.children.type === 5 /* NodeTypes.COMPOUND_EXPRESSION */) {
                ...
                for (let i = 0; i < compundChildren.length; i++) {
                    ...
                    if (child.type === 0 /* NodeTypes.INTERPOLATION */) {
...
export { createApp, createVNode as createElementBlock, createRender, createTextVnode, effect, getCurrentInstance, h, inject, nextTick, openBlock, provide, proxyRefs, ref, registerRuntimeCompiler, renderSlots, toDisplayString };
